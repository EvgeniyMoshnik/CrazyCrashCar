...
public class JoyStick extends Group {
    ...
    public JoyStick(float minHeight) {
        idle = new Image(CrazyCrashCar.atlas.findRegion("joystick"));
        addActor(idle);
        ...
        right = new Image(CrazyCrashCar.atlas.findRegion("joystick_right"));
        right.setSize(getWidth(), getHeight());
        addActor(right);

        left = new Image(CrazyCrashCar.atlas.findRegion("joystick_left"));
